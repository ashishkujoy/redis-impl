...
func TestAddInANewStream(t *testing.T) {
	streams := NewStreams()
	_, err := streams.Add("Key1", "1526919030473-0")
...
func TestAddInAExistingStream(t *testing.T) {
	streams := NewStreams()
	_, _ = streams.Add("Key1", "1526919030473-0")
	_, err := streams.Add("Key1", "1526919030473-1")
...
func TestAddWithHigherTimestampThanHeadOfStream(t *testing.T) {
	streams := NewStreams()
	_, _ = streams.Add("Key1", "1526919030473-10")
	_, err := streams.Add("Key1", "1526919030500-9")
...
func TestAddWithLowerTimestampThanHeadOfStream(t *testing.T) {
	streams := NewStreams()
	_, _ = streams.Add("Key1", "1526919030473-10")
	_, err := streams.Add("Key1", "1526919030400-9")
...
func TestIncludes(t *testing.T) {
	...
	_, _ = streams.Add("Key2", "1526919030400-10")
	contains = streams.Contains("Key1")
	assert.False(t, contains)

	_, _ = streams.Add("Key1", "1526919030400-10")
	contains = streams.Contains("Key1")
...
func TestAddWithAutogenerateSequenceInNonExistingStream(t *testing.T) {
	streams := NewStreams()
	id, err := streams.Add("Key1", "1526919030473-*")
...
func TestAddWithAutogenerateSequenceInExistingStream(t *testing.T) {
	streams := NewStreams()
	id, err := streams.Add("Key1", "1526919030473-10")
...
func TestAddWithAutogenerateSequenceInExistingStreamWithMultipleTimestampEnteries(t *testing.T) {
	...
	id, err = streams.Add("Key1", "1526919030474-10")
	assert.NoError(t, err)
	assert.Equal(t, "1526919030474-10", id)

	id, err = streams.Add("Key1", "1526919030474-*")
	assert.NoError(t, err)
