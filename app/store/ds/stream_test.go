...
func TestListNonExistingStream(t *testing.T) {
	streams := NewStreams()
	list := streams.List("Key1", NewStreamID(1526919030474, 0), NewStreamID(1526919030474, 10))
...
func TestListWithNoMatchingEntry(t *testing.T) {
	...
	entries := streams.List(
		"Key1",
		NewStreamID(1526919030471, 0),
		NewStreamID(1526919030472, 10),
	)
	assert.Equal(t, 0, len(entries))

	entries = streams.List(
		"Key1",
		NewStreamID(1526919030474, 11),
		NewStreamID(1526919030475, 10),
	)
	assert.Equal(t, 0, len(entries))

	entries = streams.List(
		"Key1",
		NewStreamID(1526919030480, 11),
		NewStreamID(1526919030470, 10),
	)
	assert.Equal(t, 0, len(entries))
}
...
func TestListWithMatchingEntry(t *testing.T) {
	...
	entries := streams.List(
		"Key1",
		NewStreamID(1526919030420, 0),
		NewStreamID(1526919030473, 0),
	)
	assert.Equal(t, 1, len(entries))

	entries = streams.List(
		"Key1",
		NewStreamID(1526919030473, 1),
		NewStreamID(1526919030473, 10),
	)
